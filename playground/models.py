...
class Warzone(models.Model):
    ...
    ship1 = models.CharField(blank=True, null=True)
    ship2 = models.CharField(blank=True, null=True)
    ship3 = models.CharField(blank=True, null=True)
    ship4 = models.CharField(blank=True, null=True)
