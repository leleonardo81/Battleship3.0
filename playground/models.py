...
class Warzone(models.Model):
    ...
    ship2 = models.CharField(max_length=20, blank=True, null=True)
    ship3 = models.CharField(max_length=20, blank=True, null=True)
    ship4 = models.CharField(max_length=20, blank=True, null=True)
